...
export const flashcardTranslations = {
    es: {
        ...
        createWordModal: {
            ...
            placeholder: "Ej: table, run, happy…",
            ...
            previewNewDeck: "Vamos a crear un mazo nuevo para \"{category} → {level}\".",
            previewExistingDeck: "Se va a agregar a tu mazo \"{deck}\" ({category} → {level}).",
            ...
            candidatesIntroSingle: "Te recomendamos esto para \"{word}\". Si no es lo que buscabas, cambiá categoría o nivel abajo.",
            candidatesIntroMultiple: "\"{word}\" tiene {count} usos comunes — armamos una tarjeta para cada uno. Destildá el que no quieras, o cambiá su categoría/nivel.",
            categoryFieldLabel: "Categoría",
            levelFieldLabel: "Nivel",
    ...
    en: {
        ...
        createWordModal: {
            ...
            placeholder: "E.g: table, run, happy…",
            ...
            previewNewDeck: "We'll create a new deck for \"{category} → {level}\".",
            previewExistingDeck: "This will be added to your \"{deck}\" deck ({category} → {level}).",
            ...
            candidatesIntroSingle: "This is what we recommend for \"{word}\". If it's not what you meant, change category or level below.",
            candidatesIntroMultiple: "\"{word}\" has {count} common uses — we put together a card for each one. Uncheck the one you don't want, or change its category/level.",
