...
export const flashcardTranslations = {
    es: {
        ...
        categorySelector: {
            ...
            createWordButtonLabel: "Agregar palabra nueva",
        ...
        createWordModal: {
            title: "Agregar palabra nueva",
            generatingTitle: "Generando con IA…",
            wordLabel: "Palabra o expresión corta",
            placeholder: "Ej: table, give up, on time…",
            helperText: "La IA detecta si es sustantivo, verbo, adjetivo, etc., arma una frase de uso cotidiano y genera imagen y audio automáticamente. Se guarda en tu mazo personal.",
            submitButton: "Siguiente",
            cancelButton: "Cancelar",
            previewingMessage: "Buscando dónde ubicarla…",
            confirmCreateButton: "Confirmar y crear",
            topicNameDefault: "Mis palabras",
            loadingMessage: "Generando con IA… puede tardar hasta un minuto.",
            successTitle: "¡Palabra creada con éxito!",
            resultsHeaderTitle: "¡Guardada con éxito!",
            resultsHeaderSubtitle: "Se generaron el audio, la imagen y la frase de ejemplo para tu mazo personal.",
            successViewButton: "Ver en {category}",
            duplicateTitle: "Ya la tenés",
            duplicateMessage: "\"{word}\" ya está en tu mazo personal de {category}.",
            errorTitle: "No se pudo crear",
            retryButton: "Reintentar",
            closeButton: "Cerrar",
            topicNameLabel: "Ponele un nombre a este mazo (opcional)",
            topicNamePlaceholder: "Ej: Palabras de trabajo",
            topicNameSkip: "Omitir",
            topicNameSave: "Guardar nombre",
            topicNameError: "No se pudo guardar el nombre. Podés intentarlo después.",
            candidatesIntroSingle: "\"{word}\" — revisá los detalles abajo antes de crearla.",
            candidatesIntroMultiple: "\"{word}\" tiene {count} usos comunes. Seleccioná cuáles querés agregar y ajustá sus detalles.",
            categoryFieldLabel: "Categoría",
            topicFieldLabel: "Destino",
            newTopicOption: "Nuevo tema",
            newTopicNameLabel: "Nombre del nuevo tema",
            newTopicNamePlaceholder: "Ej: Palabras de trabajo, Viajes…",
            duplicateBadge: "Ya la tenés",
            refreshingRow: "Actualizando…",
            addCandidateButton: "+ Agregar otra clasificación",
            addTopicButton: "+ Agregar a otro tema",
            pickTopicPrompt: "Elegí un tema tuyo:",
            pickNewCategoryOption: "Otra categoría nueva…",
            topicSuggestionLabel: "💡 Mazo sugerido:",
            topicSuggestionLinkText: "Usar {category} · {level}",
            createAnotherButton: "Crear otra palabra",
            resultsTitle: "Resultado",
            rowCreated: "Creada",
            rowDuplicate: "Ya existía",
            rowError: "No se pudo crear"
        },
        ipaModal: {
    ...
    en: {
        ...
        categorySelector: {
            ...
            createWordButtonLabel: "Add new word",
            ...
            renameTopicHint: "Click to rename",
            groups: {
                General: "General",
                Action: "Action",
        ...
        createWordModal: {
            title: "Add new word",
            generatingTitle: "Generating with AI…",
            wordLabel: "Word or short expression",
            placeholder: "E.g: table, give up, on time…",
            helperText: "AI detects whether it's a noun, verb, adjective, etc., writes an everyday usage sentence, and generates the image and audio automatically. Saved to your personal deck.",
            submitButton: "Next",
            cancelButton: "Cancel",
            previewingMessage: "Finding out where it goes…",
            confirmCreateButton: "Confirm & create",
            topicNameDefault: "My words",
            loadingMessage: "Generating with AI… this can take up to a minute.",
            successTitle: "Word Created Successfully!",
            resultsHeaderTitle: "Saved successfully!",
            resultsHeaderSubtitle: "Audio, image, and usage example were generated with AI for your personal deck.",
            successViewButton: "View in {category}",
            duplicateTitle: "Already have it",
            duplicateMessage: "\"{word}\" is already in your personal deck for {category}.",
            errorTitle: "Couldn't create it",
            retryButton: "Retry",
            closeButton: "Close",
            topicNameLabel: "Name this deck (optional)",
            topicNamePlaceholder: "E.g: Work words",
            topicNameSkip: "Skip",
            topicNameSave: "Save name",
            topicNameError: "Couldn't save the name. You can try again later.",
            candidatesIntroSingle: "\"{word}\" — review the details below before creating it.",
            candidatesIntroMultiple: "\"{word}\" has {count} common uses. Select which ones you want to add and adjust their details.",
            categoryFieldLabel: "Category",
            topicFieldLabel: "Destination",
            newTopicOption: "New topic",
            newTopicNameLabel: "New topic name",
            newTopicNamePlaceholder: "E.g. Work words, Travel…",
            duplicateBadge: "Already have it",
            refreshingRow: "Updating…",
            addCandidateButton: "+ Add another classification",
            addTopicButton: "+ Add to another topic",
            pickTopicPrompt: "Pick one of your topics:",
            pickNewCategoryOption: "A new category…",
            topicSuggestionLabel: "💡 Suggested deck:",
            topicSuggestionLinkText: "Use {category} · {level}",
            createAnotherButton: "Create another word",
            resultsTitle: "Result",
            rowCreated: "Created",
            rowDuplicate: "Already existed",
            rowError: "Couldn't create it"
        },
        ipaModal: {
            title: "Vowel Chart",
            front: "Front",
